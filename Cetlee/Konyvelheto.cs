...
namespace Cetlee
{
    public partial class Konyvelheto : Form
    {
        public Konyvelheto()
        {
            InitializeComponent();
        ...
        private void Konyvelheto_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'konyvDataSet.NBCetLeeFej' table. You can move, or remove it, as needed.
            this.nBCetLeeFejTableAdapter.Fill(this.konyvDataSet.NBCetLeeFej);
